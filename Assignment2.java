...
** Class Name:	Assignment2.java				**
** Description:	Takes in a file name which is input by the	**
**		user and puts it in a var called fileName.	**
**		It then finds that file, and reads in 	 	**
**		all info with a buffered reader. It then	**
**		prints out every line in the file and 		**
...
public class Assignment2 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			while(fileInfo != null) {										//While loop to print out the data till the file is null
